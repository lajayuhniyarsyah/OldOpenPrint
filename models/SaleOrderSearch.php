...
class SaleOrderSearch extends SaleOrder
{
    ...
    public function rules()
    {
        return [
            ...
            [['create_date', 'write_date', 'origin', 'order_policy', 'client_order_ref', 'date_order', 'note', 'state', 'date_confirm', 'name', 'invoice_quantity', 'picking_policy', 'worktype', 'delivery_date', 'attention_moved0', 'internal_notes', 'due_date'], 'safe'],
